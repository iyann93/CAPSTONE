...
const createKelasValidator = [
  ...
  body('jurusan_id').isUUID().withMessage('jurusan_id harus berupa UUID yang valid'),
];
...
const updateKelasValidator = [
  ...
  body('jurusan_id').optional().isUUID().withMessage('jurusan_id harus berupa UUID yang valid'),
];
