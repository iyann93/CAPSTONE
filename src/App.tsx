...
const App: React.FC = () => {
  ...
  // Reset scroll when menu changes or user changes
  React.useEffect(() => {
  ...
  // Automatically clean up stray Service Workers from other localhost projects
  React.useEffect(() => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F4F6FA] font-sans h-screen overflow-hidden">
      <TopBar 
        user={user} 
