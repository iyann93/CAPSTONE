...
const PaperPlaneIcon = () => (
  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="mr-2">
...
const InfoCard = ({ icon, title, description }: any) => (
  <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-4 relative overflow-hidden transition-all">
...
const ForgotPassword: React.FC<ForgotPasswordProps> = ({ onBack, onSendInstructions }) => {
