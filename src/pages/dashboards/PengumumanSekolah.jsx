          ...
          <div className="bg-white rounded-2xl w-full max-w-[600px] shadow-xl flex flex-col overflow-hidden animate-slideUp">
            ...
            <div className="p-6 overflow-y-auto max-h-[85vh] space-y-4">
              ...
              <div>
                ...
                <textarea value={newAnn.desc} onChange={e => setNewAnn({...newAnn, desc: e.target.value})} rows="3" className="w-full px-3 py-2 text-[13px] border border-gray-200 rounded-lg focus:outline-none focus:border-[#1A3D63]" placeholder="Tuliskan detail pengumuman di sini..."></textarea>
              </div>
              <div>
