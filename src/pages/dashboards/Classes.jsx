...
const SchoolIcon = () => <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    <path d="M3 21h18M3 10l9-7 9 7v11H3V10z" /><path d="M9 21v-4a3 3 0 0 1 6 0v4M12 3v1" />
  </svg>;
const UserIcon = () => <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="text-gray-400">
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" />
  </svg>;
const UsersIcon = () => <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="text-gray-400">
  ...
  return <div className="animate-fadeIn space-y-6 pb-10">
    ...
    /* Tabs */
      ...
      <div className="flex flex-wrap items-center gap-3">
        {["Semua Tingkat", "Kelas X", "Kelas XI", "Kelas XII"].map((tab) => <button
    key={tab}
    onClick={() => setActiveTab(tab)}
    className={`px-6 py-2.5 rounded-lg text-[13px] font-bold transition-all ${activeTab === tab ? "bg-[#4A7FA7] text-white shadow-lg shadow-primary-900/10" : "bg-white text-gray-500 border border-gray-100 hover:bg-gray-50"}`}
  >
            {tab}
          </button>)}
      </div>
    ...
    /* Grid List */
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {MOCK_CLASSES.map((c) => <div key={c.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-all group">
