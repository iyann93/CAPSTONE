          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-50/50">
                ...
                {days.map(day => (
                  <th key={day} className="p-6 text-center text-xs font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 min-w-[180px]">
            ...
            <tbody>
              {timeSlots.map((slot, i) => (
                <tr key={i} className={slot.isBreak ? 'bg-primary-50/30' : ''}>
                  ...
                  {slot.isBreak ? (
                    <td colSpan={5} className="p-6 text-center border-b border-gray-50">
                    ...
                    days.map(day => {
                      ...
                      return (
                        <td key={day} className="p-3 border-b border-gray-50 border-r border-gray-50/50 last:border-r-0">
                          {item ? (
                            <div className={`p-4 rounded-2xl border ${item.color} shadow-sm transition-transform hover:scale-[1.03] cursor-pointer`}>
