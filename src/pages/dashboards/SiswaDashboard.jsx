...
const CalendarIcon = () => <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
    <rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" />
  </svg>;
const AwardIcon = () => <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
    <path d="M12 15l-2 5L12 18l2 2-2-5z" />
    <circle cx="12" cy="8" r="7" />
    <circle cx="12" cy="8" r="3" />
  </svg>;
const FileTextIcon = () => <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" />
  </svg>;
const BoltIcon = () => <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
  </svg>;
const DashboardOverview = ({ user, onViewChange }) => {
  const firstName = user.fullName.split(" ")[0];
  return <main className="flex-1 p-4 md:p-8 flex flex-col gap-6 md:gap-8 overflow-y-auto bg-gray-50/50 h-full">
  ...
  ].map((item, i) => <div key={i} className="flex items-center justify-between group">
...
const SiswaDashboard = ({ user, activeMenu, onViewChange }) => {
  const renderView = () => {
    switch (activeMenu) {
      case "Dashboard":
      ...
      default:
        return <div className="p-8 text-center text-gray-400 h-full flex items-center justify-center">
...
var SiswaDashboard_default = SiswaDashboard;
export {
  SiswaDashboard_default as default
};
