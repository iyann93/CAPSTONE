              ...
              <div className="p-6 space-y-6">
                <div className={`p-4 border rounded-xl ${selectedStudent.status === 'Aktif' ? 'bg-[#F0FDF4] border-[#DCFCE7]' : 'bg-gray-50 border-gray-100'}`}>
                  <div className="flex items-center gap-2 mb-1">
                    <div className={`w-2 h-2 rounded-full ${selectedStudent.status === 'Aktif' ? 'bg-[#16A34A] animate-pulse' : 'bg-gray-400'}`}></div>
    ...
    <div className="animate-fadeIn space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-5">
                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-bold border ${
                      ...
                      <div className={`w-1.5 h-1.5 rounded-full ${s.status === 'Aktif' ? 'bg-[#16A34A]' : 'bg-gray-400'}`}></div>
                      {s.status}
                    </span>
                  </td>
                  <td className="px-6 py-5">
        ...
        <div className="p-5 bg-white border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
          <span className="text-[13px] text-gray-500">Menampilkan 1 sampai 8 dari 1,248 siswa</span>
