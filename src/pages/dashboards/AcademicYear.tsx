...
const ChevronDownIcon = () => (
  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" className="text-gray-400">
    <path d="m6 9 6 6 6-6"/>
  </svg>
)
...
const InfoIcon = () => (
  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="text-gray-400 mt-0.5 shrink-0">
    <circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>
  </svg>
)

const WarningIcon = () => (
  <svg width="16" height="16" fill="none" stroke="#EAB308" strokeWidth="2" viewBox="0 0 24 24" className="mt-0.5 shrink-0">
              ...
              <div className="p-6 space-y-4">
                ...
                <label className="flex items-center gap-4 py-3.5 px-5 border border-gray-200 rounded-full cursor-pointer hover:bg-gray-50 transition-colors">
                  <div className="relative flex items-center shrink-0">
                    ...
                    <svg className="absolute w-5 h-5 text-white pointer-events-none opacity-0 peer-checked:opacity-100 p-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="20 6 9 17 4 12"></polyline></svg>
                  </div>
                  <div>
          ...
          {years_data.map((year) => (
            <div key={year.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-6">
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${
                    year.status === 'Aktif' ? 'bg-[#5EE9B5]/10 text-[#5EE9B5]' : 'bg-gray-100 text-gray-400'
                  }`}>
                    {year.status === 'Aktif' ? (
                      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M8 11V7a4 4 0 1 1 8 0m-4 13a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/><rect x="5" y="11" width="14" height="10" rx="2"/></svg>
                    ) : (
                      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="5" y="11" width="14" height="10" rx="2"/><circle cx="12" cy="16" r="1"/><path d="M8 11V7a4 4 0 1 1 8 0"/></svg>
                    )}
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <span className={`px-4 py-1 rounded-full text-[11px] font-bold ${
                    year.status === 'Aktif' ? 'bg-[#5EE9B5]/20 text-[#2B8B67]' : 'bg-gray-100 text-gray-400'
                  }`}>
                    {year.status}
                  </span>
              ...
              {expandedYear === year.id && (
                <div className="p-8 pt-2 border-t border-gray-50 animate-fadeIn">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
             ...
             <div className="space-y-3">
               {agenda_items.map((item) => (
                 <div key={item.id} className={`${item.color} rounded-xl p-4 shadow-sm transition-transform hover:-translate-y-1 cursor-pointer`}>
