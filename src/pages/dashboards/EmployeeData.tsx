...
const ExportIcon = () => (
  <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="mr-1.5">
    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>
  </svg>
)

const BriefcaseIconSmall = () => (
  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="mr-2 text-[#1A3D63]">
    <rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/>
  </svg>
)

const ChevronDownIcon = () => (
  <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" className="text-gray-400">
    <path d="m6 9 6 6 6-6"/>
  </svg>
)
...
const UploadIcon = () => (
  <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="mr-2">
...
const EmployeeData: React.FC = () => {
  ...
  const handleEditClick = (employee: EmployeeRecord) => {
              ...
              <div className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select defaultValue="Perempuan" className="w-full appearance-none px-4 py-3 bg-[#F9FAFB] border border-gray-200 rounded-xl text-[14px] font-semibold text-[#1F2937] focus:outline-none focus:ring-2 focus:ring-[#1A3D63]/5 transition-all">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select defaultValue="Islam" className="w-full appearance-none px-4 py-3 bg-[#F9FAFB] border border-gray-200 rounded-xl text-[14px] font-semibold text-[#1F2937] focus:outline-none focus:ring-2 focus:ring-[#1A3D63]/5 transition-all">
                        <option>Islam</option>
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      type="email" 
                      defaultValue={selectedEmployee.email || 'sri.wahyuni@gmail.com'}
                      className="w-full px-4 py-3 bg-[#F9FAFB] border border-gray-200 rounded-xl text-[14px] font-semibold text-[#1F2937] focus:outline-none focus:ring-2 focus:ring-[#1A3D63]/5 focus:bg-white transition-all"
                    />
                  </div>
                  <div className="col-span-1 md:col-span-2 space-y-2">
                    ...
                    <textarea 
                      rows={3}
                      defaultValue="Komp. Griya Indah Blok B/12, Antapani, Jakarta Selatan"
              ...
              <div className="p-6 space-y-6">
                <div className={`p-4 border rounded-xl ${selectedEmployee.status === 'Aktif' ? 'bg-[#F0FDF4] border-[#DCFCE7]' : 'bg-gray-50 border-gray-100'}`}>
                  <div className="flex items-center gap-2 mb-1">
                    <div className={`w-2 h-2 rounded-full ${selectedEmployee.status === 'Aktif' ? 'bg-[#16A34A] animate-pulse' : 'bg-gray-400'}`}></div>
    ...
    <div className="animate-fadeIn space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-1.5 bg-[#1A3D63] hover:bg-[#0A1931] text-white px-5 py-2.5 rounded-lg font-bold text-[13px] shadow-lg shadow-primary-900/10 transition-all">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:block text-[13px] text-gray-400 font-medium ml-4">
            Menampilkan <span className="text-[#1F2937] font-bold">8 dari 112</span> data
          </div>
        </div>
      </div>
