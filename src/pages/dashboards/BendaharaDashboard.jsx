            ...
            <div className="mb-6 bg-[#F8F9FA] rounded-2xl p-5">
              ...
              <div className="space-y-4 text-[13px]">
                <div className="flex justify-between items-center">
                  <span className="text-[#475569]">Kelas VII</span>
                  <span className="font-bold text-[#1e293b]">30 siswa</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#475569]">Kelas VIII</span>
                  <span className="font-bold text-[#1e293b]">40 siswa</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#475569]">Kelas IX</span>
                  <span className="font-bold text-[#1e293b]">31 siswa</span>
                </div>
              </div>
