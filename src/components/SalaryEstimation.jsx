...
const ArrowUpIcon = () => <svg width="14" height="14" fill="none" stroke="#22c55e" strokeWidth="2.5" viewBox="0 0 24 24">
...
var SalaryEstimation_default = SalaryEstimation;
export {
  SalaryEstimation_default as default
};
