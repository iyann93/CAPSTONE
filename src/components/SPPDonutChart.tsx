...
const sppData: SppData[] = [
  { name: 'Lunas', value: 973, fill: '#22c55e' },
  { name: 'Menunggak', value: 275, fill: '#f59e0b' },
]

const SPPDonutChart: React.FC = () => {
  return (
    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 w-full flex-shrink-0">
